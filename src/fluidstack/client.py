...
class FluidStack:
    ...
    api_token : typing.Optional[typing.Union[str, typing.Callable[[], str]]]
    ...
    def __init__(
        ...
        *,
        ...
        api_key: typing.Optional[typing.Union[str, typing.Callable[[], str]]] = os.getenv("FLUIDSTACK_API_KEY"),
        api_token: typing.Optional[typing.Union[str, typing.Callable[[], str]]] = os.getenv("FLUIDSTACK_API_TOKEN"),
